...
namespace AxxAddCartLinesToCartReport.CommerceRuntime.ProcessReport
{
    public class GenerateReport
    {
        ...
        //resource
        private string relativePath = @$"K:\BranchsLG\TemplateProjectCmmSDK\CmmSDK\src\AxxAddCartLinesToCartReport\CommerceRuntime\Resources";
        ...
        //private static void AddDataSourcesToReport(AxxQuotationReportModelDataModel dataModel, LocalReport report)
        //{
        //    // Obtener todas las propiedades de DataModel
        //    PropertyInfo[] properties = typeof(AxxQuotationReportModelDataModel).GetProperties();
